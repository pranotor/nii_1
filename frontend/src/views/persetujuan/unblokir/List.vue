    ...
    <vs-row vs-justify="center">
     <vs-col type="flex" vs-justify="center" vs-align="center" vs-lg="12" vs-xs="12">
       <vs-card>  
         ...
         <h3 class="card-title mb-0">Permintaan Buka Blokir Customer</h3>
         <div class="ml-auto">
         ...
         <JqxMenu ref="myMenu" @itemclick="myMenuOnItemClick($event)"
             ...
             <ul>
                 <li id="edit">Setuju Buka Blokir</li>
   ...
   export default {
     ...
     methods: {
         ...
         acceptAlert(){
             ...
             this.$http.post('/api/customerblokir',{
                 ...
                 this.$vs.notify({title:'BERHASIL..',text:'Pengajuan buka blokir sudah disetujui..',color:'primary'})
             }).catch(error => {
                 this.$vs.notify({title:'GAGAL PROSES..',text:'Pengajuan buka blokir gagal diproses..',color:'danger'})
             })
         ...
         myMenuOnItemClick: function (event) {
             ...
             else if(args.innerHTML == 'Setuju Buka Blokir'){
                 this.editrow = rowindex;
                 let dataRecord = this.$refs.myGrid.getrowdata(this.editrow)
     ...
     beforeCreate: function () {
       this.source = {
         ...
         datatype: 'json',
         id: 'id',
         url: this.$urlbackend+'/api/customerblokir/2',
         type: 'get',
