    ...
    <vs-row vs-justify="center">
     <vs-col vs-lg="12" vs-xs="12" vs-sm="12">
       <vs-card>
         ...
         <h3 class="card-title mb-0">Retur {{this.$route.params.ref}}</h3>
         <div class="ml-auto">
         ...
         <div >            
             <vs-table  :data="formdata.datatrans" class="text-nowrap">
                 ...
                 <template slot-scope="{data}">
                     ...
                     <vs-td vs-align="right">{{ data[indextr].nama_barang2 }}</vs-td>
                     <vs-td vs-align="right">{{ data[indextr].qty_kirim }}</vs-td>
     ...
     methods:{
         ...
         getAllData: function(){
             ...
             if(this.$route.params.ref != null){
                 ...
                 let url = "/api/sjbyno/"+this.$route.params.ref;
                 ...
                 const keys = Object.keys(response.data)
                    for(const key of keys){
                        ...
                        subkeys.forEach(item => {
                            ...
                            if(item =='sj'){
                                this.formdata.cust_id = response.data[key][item]['sales']['cust_id'];
                                this.formdata.inv_no = response.data[key][item]['inv_no'];
                                this.formdata.sj_no = response.data[key][item]['sj_no'];
                            }
         ...
         handleSuccess: function(){
             ...
             this.$router.push({name : 'returindex'});
         },
         notify: function(){
             this.$vs.notify({
