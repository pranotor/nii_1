   ...
   <vs-row vs-justify="center">
    <vs-col vs-lg="12" vs-xs="12" vs-sm="12">
      ...
      <vs-card>
        ...
        <h3 class="card-title mb-0">Input Jurnal Umum {{this.$route.params.ref}}</h3>
        <div class="ml-auto">
        ...
        <div>
          ...
          <vs-col vs-lg="6" vs-xs="12" vs-sm="4">  
            <vs-select autocomplete class="w-100 mt-4" label="UNIT" v-model="formdata.unit">
              <vs-select-item
                :key="index"
                :value="item.unit"
                :text="item.nm_unit"
          ...
          <vs-input icon-before="true" label-placeholder="URAIAN" icon="mode_edit" class="mt-4 w-100" ref="uraian" v-model.lazy="formdata.uraian"/>
          <vs-row>
        ...
        <hr class="custom-hr" />
        <div>            
            <vs-table v-if="formdata.datatrans.length >0" :data="formdata.datatrans" class="text-nowrap">
                ...
                <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-lg="5" vs-sm="4" vs-xs="12">
                    <h5>TOTAL DEBET : {{sumDebet}}</h5> 
                </vs-col>
                <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-lg="5" vs-sm="4" vs-xs="12">
                    <h5>TOTAL KREDIT : {{sumKredit}}</h5> 
                </vs-col>
    ...
    methods:{
        ...
        getAllData: function(){
            ...
            if(this.$route.params.ref != null){
                this.$http.get('/api/ju/'+this.$route.params.ref).then(response => {
                    console.log(response.data)
