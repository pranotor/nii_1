   ...
   <vs-row vs-justify="center">
    <vs-col vs-lg="12" vs-xs="12" vs-sm="12">
      ...
      <vs-card>
        ...
        <h3 class="card-title mb-0">Pegawai {{this.$route.params.ref}}</h3>
        <div class="ml-auto">
        ...
        <div>
          <vs-row>
            <vs-col vs-lg="2" vs-xs="12" vs-sm="3">  
                <vs-input label="NIK" class="w-100 mt-4" ref="transval" v-model="formdata.nik" /> 
            </vs-col>
            <vs-col vs-lg="4" vs-xs="12" vs-sm="3">  
                <vs-input label="NAMA" class="w-100 mt-4" ref="transval" v-model="formdata.nama" /> 
            </vs-col>
            <vs-col vs-lg="6" vs-xs="12" vs-sm="3">  
                <vs-input label="JABATAN" class="w-100 mt-4" ref="transval" v-model="formdata.jabatan" /> 
            </vs-col>
          </vs-row>
        </div>
    ...
    methods:{
        ...
        checkForm:function(e) {
            ...
            if(this.formdata.nik == ''){
                this.errors.push("NIK belum terisi...")
            }
            ...
            if(this.formdata.jabatan == ''){
                this.errors.push("Jabatan belum terisi...")
            }
        ...
        handleSuccess: function(){
            ...
            this.$router.push({name : 'pegawailist'});
        },
        notify: function(){
            this.$vs.notify({
