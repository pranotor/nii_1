  ...
  export default {
    ...
    data: function () {
      return {
        ...
        width: "100%",
        columns: [
          { text: 'NIK', datafield: 'nik', width: '20%', },
          { text: 'Nama', datafield: 'nama', width: '20%', },
          { text: 'Jabatan', datafield: 'jabatan', width: '60%'}
        ],
        selectrow: 0,
        routeEdit: 'pegawaiedit'
      }
    },
    methods: {
        ready: function() {
        ...
        inputForm: function(){
            this.$router.push({name : 'pegawaiinput'});
        },
        ...
        myMenuOnItemClick: function (event) {
            ...
            if (args.innerHTML == 'Edit') {
                ...
                if(confirm("Yakin menghapus data?")){
                    this.$http.delete('/api/pegawai/' + data.nik).then(resp => {
                        console.log(resp)
    ...
    beforeCreate: function () {
      this.source = {
        ...
        datatype: 'json',
        id: 'kode',
        url: this.$urlbackend+'/api/pegawai',
        type: 'get',
