   ...
   <vs-row vs-justify="center">
    <vs-col vs-lg="12" vs-xs="12" vs-sm="12">
      ...
      <vs-card>
        ...
        <h3 class="card-title mb-0">Rekanan {{this.$route.params.ref}}</h3>
        <div class="ml-auto">
        ...
        <div>
          <vs-row>
            <vs-col vs-lg="2" vs-xs="12" vs-sm="3">  
                <vs-input label="KODE" class="w-100 mt-4" ref="transval" v-model="formdata.kode" /> 
            </vs-col>
    ...
    methods:{
        ...
        checkForm:function(e) {
            ...
            if(this.formdata.kode == ''){
                this.errors.push("Kode belum terisi...")
            }
        ...
        handleSuccess: function(){
            ...
            this.$router.push({name : 'rekananlist'});
        },
        notify: function(){
            this.$vs.notify({
