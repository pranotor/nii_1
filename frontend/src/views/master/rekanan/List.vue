   ...
   <vs-row vs-justify="center">
    <vs-col type="flex" vs-justify="center" vs-align="center" vs-lg="12" vs-xs="12">
      <vs-card>  
        ...
        <h3 class="card-title mb-0">Vendor</h3>
        <div class="ml-auto">
  ...
  export default {
    ...
    data: function () {
      return {
        ...
        width: "100%",
        columns: [
          { text: 'Kode', datafield: 'kode', width: '20%', },
          { text: 'Nama', datafield: 'nama', width: '20%', },
          { text: 'Alamat', datafield: 'alamat', width: '60%'}
        ],
        selectrow: 0,
        routeEdit: 'rekananedit'
      }
    },
    methods: {
        ready: function() {
        ...
        inputForm: function(){
            this.$router.push({name : 'rekananinput'});
        },
    ...
    beforeCreate: function () {
      this.source = {
        ...
        datatype: 'json',
        id: 'kode',
        url: this.$urlbackend+'/api/rekanan',
        type: 'get',
