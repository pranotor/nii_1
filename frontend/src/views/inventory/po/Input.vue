   ...
   <vs-row vs-justify="center">
    <vs-col vs-lg="12" vs-xs="12" vs-sm="12">
      ...
      <vs-card>
        ...
        <h3 class="card-title mb-0">Purchase Order {{this.$route.params.ref}}</h3>
        <div class="ml-auto">
        ...
        <vs-alert v-if="errors.length" class="mb-3 mt-2"  color="danger">
          ...
          <div>
            ...
            <vs-row>
                <vs-col vs-lg="6" vs-xs="12" vs-sm="4">  
                    <vs-select class="w-100 mt-1" label="Kode Barang - Nama Barang" ref="barang" v-model="barang" 
                    danger-text="Kode Perkiraan tidak sesuai"
                    :danger="errorBarang">
                    <vs-select-item
                        :key="index"
            ...
            <vs-table  :data="formdata.datatrans" class="text-nowrap">
                ...
                <template slot-scope="{data}">
                    ...
                    <vs-td vs-align="right" v-if="jenisJurnal=='bpbposting'">
                        <vs-input class="w-1" v-model="data[indextr].harga" v-currency="options"/>
                    </vs-td>
