   ...
   <vs-row vs-justify="center">
    <vs-col vs-lg="12" vs-xs="12" vs-sm="12">
      ...
      <vs-card>
        ...
        <h3 class="card-title mb-0">User {{this.$route.params.ref}}</h3>
        <div class="ml-auto">
        ...
        <div>
          <vs-row>
            ...
            <vs-col vs-lg="4" vs-xs="12" vs-sm="3">  
                <vs-select  class="w-100 mt-4" ref="rekanan" label="CUSTOMER" v-model="formdata.role_id">
                <vs-select-item
                    :key="index"
            ...
            <vs-col vs-lg="4" vs-xs="12" vs-sm="3">  
                <vs-select  class="w-100 mt-4" ref="rekanan" label="ACTIVITY" v-model="formdata.activity">
                <vs-select-item
                    :key="index"
                    :value="item.id"
                    :text="item.name"
                    v-for="(item,index) in optactivity"
                />
                </vs-select>
            </vs-col>  
          ...
          <vs-row>
             <vs-col vs-lg="12" vs-xs="12" vs-sm="4"> 
              <vs-textarea label="MEMO" ref="uraian" v-model.lazy="formdata.uraian" class="mt-4 w-100" />
             </vs-col>
          </vs-row>
        </div>
  ...
  export default {
    ...
    data: function () {
      return {
        ...
        optcustomer:[{ 'CustomerID': 'AAA', 'CompanyName': 'PT MAJU TERUS', 'ContactName': 'Siti Maimunah', 'ContactTitle': 'Sales Representative', 'City': 'Bandung', 'Country': 'Indonesia' },
        ...
        optactivity:[{ 'id': '1', 'name': 'PHONE CALL'},{ 'id': '2', 'name': 'VISIT'},{ 'id': '3', 'name': 'QUOTATION'},{ 'id': '4', 'name': 'SALES ORDER'}],            
        errors:[],
        idtrans:0,
        inputUrl: '/api/userapp'
      }
    },
    methods:{
        backpage: function(){
        ...
        checkForm:function(e) {
            ...
            if(this.formdata.email == ''){
                this.errors.push("User ID belum terisi...")
            }
            ...
            if(this.formdata.role_id == ''){
                this.errors.push("Role belum dipilih...")
            }

            if(this.formdata.password == ''){
                this.errors.push("Password belum terisi...")
            }
