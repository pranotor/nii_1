        ...
        <vs-row vs-justify="center">
            ...
            <vs-card>
                <div class="d-md-flex align-items-center pb-2">
                    <h3 class="card-title mb-0">Proses Produksis {{this.$route.params.ref}}</h3>
                    <div class="ml-auto">
                ...
                this.$http.get("api/produksi/"+this.$route.params.ref).then(response => {
                    ...
                    for(const key of keys){
                        ...
                        subkeys.forEach(item => {
                            ...
                            if(item =='wo_id'){
                                this.wo_id = response.data[key][item];
                                this.getWO(response.data[key][item]);
                            }
                            if(item == 'prod_tgl'){
                            ...
                            if(item == 'detail'){
                                ...
                                if(item.qty < 0){
                                    ...
                                    self.formdata.barang_hasil = item.qd_id;
                                    self.formdata.qty_hasil = item.qty;
                                    self.formdata.prev_barang_hasil = item.qd_id;
                                } 
                            })
                            }    
                        })
