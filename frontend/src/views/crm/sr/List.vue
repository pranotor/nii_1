   ...
   <vs-row vs-justify="center">
    <vs-col type="flex" vs-justify="center" vs-align="center" vs-lg="12" vs-xs="12">
      <vs-card>  
        ...
        <h3 class="card-title mb-0">Sample Request</h3>
        <div class="ml-auto">
  ...
  export default {
    ...
    methods: {
        ...
        myMenuOnItemClick: function (event) {
            ...
            if (args.innerHTML == 'Edit') {
                ...
                this.$router.push({name : 'sredit', params: { ref: referensi }});
            }
    ...
    beforeCreate: function () {
      this.source = {
        ...
        datatype: 'json',
        id: 'referensi',
        url: this.$urlbackend+'/api/samplelist',
        type: 'post',
