...
class JbkController extends Controller
{
    /**
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreJbk $request)
    {
        ...
        DB::transaction(function () use ($data) {
            ...
            foreach($data['formdata']['dataDebet'] as $jurnal){
                ...
                $jbk_input['document'] = $data['formdata']['no_cheq'];
    ...
    public function bayardata($no_jurnal){
        return Response::json(Voucherbayar::where('ref_jurnal',$no_jurnal)->first());
    }
}
