...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr class="noborder">
    <td width="100%"  align="center"><span style="font-size: 14pt; text-decoration:bold"><u>KARTU STOCK PERSEDIAAN</u></span></td>
  </tr>
  <tr class="noborder">
    @if($periode=='bl')
  ...
  @foreach($data_jurnal as $j)
    ...
    @if($j->kode_perk != '-')
        ...
        <table width="100%" border="1" cellpadding="5" cellspacing="0">
            ...
            <tr>
                <th style= "width: 15%; border-bottom-width:0.1px;"><strong>Tanggal</strong></th>
                ...
                <th style= "width: 14%; border-bottom-width:0.1px;"><strong>Saldo Akhir</strong></th>
            </tr>
            </thead>
    @else
    <?php
