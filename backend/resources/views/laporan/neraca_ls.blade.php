...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr class="noborder">
        <td width="100%"  align="center"><span style="font-size: 14pt; text-decoration:bold"><u>N E R A C A</u></span></td>  
    </tr>  
    <tr class="noborder">
      @if($periode=='bl')
    ...
    <tr>
        <td width="49%" valign="top">
            <table width="100%" border="1" cellpadding="5" cellspacing="0">
                <thead>
                <tr>
                  <th style= "width: 44%; border-bottom-width:0.1px;" rowspan="2"><strong>NAMA PERKIRAAN</strong></th>
                  <th style= "width: 17%; border-bottom-width:0.1px;" rowspan="2"><strong>{{$str_periode}} INI</strong></th>
                  <th style= "width: 17%; border-bottom-width:0.1px;" rowspan="2"><strong>{{$str_periode}} LALU</strong></th>
